...
run('cp -r get_syn_regions.py run_synthology_nucl.py run_synthology_prot.py compute_ortho_stats.py make_ortho_tables.py plot_ortho_stats.py README_synthology out/stable/synthology',shell=True)
...
run('cp -r README_custom draw_simple.py draw_verbose.py find_pot_homologs.py out/experimental/custom',shell=True)
