...
run('cp -r get_syn_regions.py run_synthology_nucl.py run_synthology_prot.py compute_ortho_stats.py make_ortho_tables.py plot_ortho_stats.py run_blast_on_regions.py blast_results_to_synthology.py extract_syntenic_fastas.py draw_verbose.py draw_synorthogroups.py generate_plotting_order.py export_synorthogroups.py SYNORTHOGROUPS_README.md README_synthology compute_element_stats.py make_element_tables.py plot_element_stats.py out/stable/synthology',shell=True)
...
run(f'cp -r README_utils pairwise_alignments_table replace_names.py mapping get_mapping.py clasp.x orgs {ad}/aligned_succinct {ad} ../utils/small_meta NJTree.nwk UPGMATree.nwk convert_ncbi_idents.py root_NJ_tree_at_midpoint.py out/utils',shell=True)
...
run('cp -r README_scripts make_gff3.py archive/eval_dups_only_syn.py add_dups_to_anchors.py make_dup_free_ams.py make_chr_and_org_mapping_for_gff.py archive/compress_maps_and_ignore_multis_with_dups.py get_gff_pairwise_succinct.py make_pw_table_from_aligned.py phylogeny_from_anchors.py out/scripts_which_produced_these_results',shell=True)
