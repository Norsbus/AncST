...
run('cp -r README_MCScanX MCScanX.gff MCScanX.homology put_coords_into_MCScanX_gff_and_homology.py extract_MCScanX_orthologies_clusters.py extract_MCScanX_orthologies_pairwise.py phylogeny_from_mcscanx.py out/MCScanX',shell=True)
run('cp -r README_utils replace_names.py mapping get_mapping.py clasp.x find_pot_homologs.py orgs compressed_maps_multis_to_one/ ../anchors ../utils/small_meta out/utils',shell=True)
