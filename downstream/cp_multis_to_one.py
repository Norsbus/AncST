...
run('cp -r README_MCScanX orgs MCScanX.gff MCScanX.homology put_coords_into_MCScanX_gff_and_homology.py extract_MCScanX_orthologies_clusters.py extract_MCScanX_orthologies_pairwise.py phylogeny_from_mcscanx.py get_orders.py get_mc_blocks.py sc_mcdraw.py mcdraw.py convert_ncbi_idents.py root_NJ_tree_at_midpoint.py out/MCScanX',shell=True)
run(f'cp -r README_utils replace_names.py mapping get_mapping.py clasp.x find_pot_homologs.py orgs compressed_maps_multis_to_one/ {ad} ../utils/small_meta NJTree.nwk UPGMATree.nwk convert_ncbi_idents.py root_NJ_tree_at_midpoint.py out/utils',shell=True)
