...
run(f'cp -r README_utils pairwise_alignments_table replace_names.py mapping get_mapping.py clasp.x orgs {ad} ../utils/small_meta NJTree.nwk UPGMATree.nwk convert_ncbi_idents.py root_NJ_tree_at_midpoint.py out/utils',shell=True)
...
run('cp -r README_scripts make_gff3.py add_dups_to_anchors.py make_dup_free_ams.py make_chr_and_org_mapping_for_gff.py get_gff_pairwise_succinct.py make_pw_table_from_aligned.py phylogeny_from_anchors.py out/scripts_which_produced_these_results',shell=True)
