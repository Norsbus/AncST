- PREREQUISITE: get blossom library from https://pub.ista.ac.at/~vnk/software.html and compile in blossom5-v2.05.src (path is hardcoded, otherwise adjust in python files)
