...
# YOU NOW NEED FILTER_PARAMS with first 5 (k,e,l,i,p) defined and some "original" params file (for downstream scripts with the word_sizes...) and a file "compute_anchors_for" with species and "compare" with species pairs
