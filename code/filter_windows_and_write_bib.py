...
def init_dict(org,idx):
    ...
    for abs_start,abs_end in idx:
        ...
        if idx_l > 0:
            ...
            l = 0
        chromo_start = abs_start - l
        chromo_end = abs_end - l
...
def combine_and_filter_new_ones(idx,bib=False):
    ...
    for i,j in enumerate(old_idx):
        #### just for this function to repeat filter_windows..... #### was originally for "unbaised..." paper
