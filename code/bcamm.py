...
def blast_clasp_anchor_map_making(orgs_tuple,file,ws):
    ...
    # blast forward
    blast(f'{work_dir}/blastdbs/anchor_candidates_'+org1+'_forward',f'{work_dir}/sequences_to_compare/{org2}/forward_split/forward.{file}',f'{work_dir}/blast_out_forward/{orgs_tuple}/{file}',ws)
    # blast reverse 
    blast(f'{work_dir}/blastdbs/anchor_candidates_'+org1+'_forward',f'{work_dir}/sequences_to_compare/{org2}/reverse_split/reverse.{file}',f'{work_dir}/blast_out_reverse/{orgs_tuple}/{file}',ws)
    # clasp forward
